...
// todo: allow override of name, main, base in file w/ command line opts
function readProject(directory, options) {
  ...
  if (!project.api.basePath) { project.api.basePath = project.name; } // todo: add '/' and escape
...
// todo: allow override of package.json...
